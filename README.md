...
直接打开 `build/AppleIIEmulator.app` 即可运行。首次启动默认使用内置 Apple IIc ROM 04 和测试启动盘；屏幕显示 `DISK BOOT OK Apple //c` 代表真实 ROM、IWM、GCR 解码和 `$0801` 引导链已完成。点一下屏幕即可输入；若要验证键盘回显，可在“ROM”菜单选择“内置诊断 ROM”。
